...
abstract class Collection implements ArrayAccess, Countable
{
    /**
     ...
     * @return $this
     */
    public function makeFirst(string $item): self
    {
     ...
     * @return $this
     */
    public function makeLast(string $item): self
    {
        if (isset($this->items[$item])) {
     ...
     * @return void
     */
    public function pull(string $key): void
    {
     ...
     * @return void
     */
    protected function executeBeforeCallback(): void
    {
